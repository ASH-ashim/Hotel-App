  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subtitle="Manage your hotel effortlessly — track bookings, add rooms, and stay in control of your business operations, all in one place."
      />
      ...
      <div className="flex gap-4 my-8">
        ...
        <div className="bg-primary/3 border border-primary/10 rounded flex p-4">
          <div className="flex flex-col sm:ml-4 font-medium">
            ...
            <p className="text-neutral-400 text-base">
              NPR {dashboardData.totalRevenue}
            </p>
          </div>
        </div>
      </div>
