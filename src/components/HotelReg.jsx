    ...
    return (
        ...
        justify-center bg-black/70">
            <form className="flex bg-white rounded-xl max-w-4xl w-full max-md:mx-2">
                <img src={assets.regImage} alt="regImg" className="w-1/2 rounded-xl
                hidden md:block" />
                ...
                <input id='name' type="text" placeholder="type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1
                ...
                <input id="address" type="text" placeholder="type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1
                outline-indigo-500 font-light" required />
                    </div>

                    {/* Select City */}
                    <div className="w-full mt-4">
                        <label for="city" className="font-medium text-gray-500">City</label>
